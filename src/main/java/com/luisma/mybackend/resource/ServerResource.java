...
public class ServerResource {
    ...
    @PostMapping("/save")
    public ResponseEntity<Response> saveServers(@RequestBody @Validated Server server) {
        return ResponseEntity.ok(
                Response.builder()
                        .timeStamp(LocalDateTime.now())
    ...
    public byte[] getServerImage(@PathVariable("id") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "Dowloads/images/" + fileName));
    }
